    ...
    <div style="padding: 15px 20px">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          ...
          <div style=" margin-top: 15px"><span style="font-size: 20px; color: #ff5000;"><b>¥{{goodsData.price}}/{{goodsData.unit}}</b></span><span style="color: #666666FF;"> · 已售 {{goodsData.count}} · 不足 {{goodsData.inventory}}</span></div>
          ...
          <div style="color: #666666FF; margin-top: 20px">分类：<a href="#" @click.prevent="goTo('/front/category?id=' + goodsData.categoryId)">{{goodsData.categoryName}}</a></div>
